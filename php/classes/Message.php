...
class Message implements \JsonSerializable {
	...
	(int $newMessageId = null, int $newMessagePostId = null, int $newMessageReceiverProfileId, int $newMessageSenderProfileId, string $newMessageBrowser, string $newMessageContent, string $newMessageIpAddress, int $newMessageStatus, \DateTime $newMessageTimestamp) {
		try{
	 ...
	 */
		public function update(\PDO $pdo){
			...
			//create query
			$query = "UPDATE message SET messageStatus = :messageStatus";
			$statement = $pdo->prepare($query);
			//bind variables
